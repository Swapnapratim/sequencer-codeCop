...
export interface SpotEngineInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addProduct"
      | "applyDeltas"
...
export interface SpotEngine extends BaseContract {
  connect(runner?: ContractRunner | null): SpotEngine;
  waitForDeployment(): Promise<this>;

  interface: SpotEngineInterface;
  ...
  updateProduct: TypedContractMethod<[tx: BytesLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[tx: BytesLike], [void], "nonpayable">;
  getFunction(
