...
export interface PerpEngineLpInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "applyDeltas"
      | "balances"
...
export interface PerpEngineLp extends BaseContract {
  connect(runner?: ContractRunner | null): PerpEngineLp;
  waitForDeployment(): Promise<this>;

  interface: PerpEngineLpInterface;
