...
export interface PerpEngineStateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "applyDeltas"
      | "balances"
...
export interface PerpEngineState extends BaseContract {
  connect(runner?: ContractRunner | null): PerpEngineState;
  waitForDeployment(): Promise<this>;

  interface: PerpEngineStateInterface;
  ...
  lpBalances: TypedContractMethod<
    [arg0: BigNumberish, arg1: BytesLike],
    [[bigint, bigint] & { amount: bigint; lastCumulativeFundingX18: bigint }],
    "view"
  >;
