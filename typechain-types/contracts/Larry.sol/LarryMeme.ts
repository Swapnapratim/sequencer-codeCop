...
export interface LarryMemeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "airdrop"
      | "airdrop_supply"
...
export interface LarryMeme extends BaseContract {
  connect(runner?: ContractRunner | null): LarryMeme;
  waitForDeployment(): Promise<this>;

  interface: LarryMemeInterface;
  ...
  airdrop_supply: TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "airdrop_supply"
