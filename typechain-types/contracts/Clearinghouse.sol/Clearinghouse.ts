...
export interface ClearinghouseInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "_isAboveInitial",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "_isUnderInitial",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface Clearinghouse extends BaseContract {
  ...
  _isAboveInitial: TypedContractMethod<
    [subaccount: BytesLike],
    [boolean],
    "view"
  >;

  _isUnderInitial: TypedContractMethod<
    [subaccount: BytesLike],
    [boolean],
    "view"
  >;
  ...
  claimSequencerFees: TypedContractMethod<
    [txn: IEndpoint.ClaimSequencerFeesStruct, fees: BigNumberish[]],
    [void],
    "nonpayable"
  >;

  depositCollateral: TypedContractMethod<
    [txn: IEndpoint.DepositCollateralStruct],
    [void],
    "nonpayable"
  >;

  depositInsurance: TypedContractMethod<
    [txn: IEndpoint.DepositInsuranceStruct],
    [void],
    "nonpayable"
  >;

  getAllBooks: TypedContractMethod<[], [string[]], "view">;
  ...
  updateFeeRates: TypedContractMethod<
    [txn: IEndpoint.UpdateFeeRatesStruct],
    [void],
    "nonpayable"
  >;
  ...
  withdrawCollateral: TypedContractMethod<
    [txn: IEndpoint.WithdrawCollateralStruct],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "_isAboveInitial"
  ): TypedContractMethod<[subaccount: BytesLike], [boolean], "view">;
  getFunction(
    nameOrSignature: "_isUnderInitial"
  ): TypedContractMethod<[subaccount: BytesLike], [boolean], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[txn: IEndpoint.BurnLpStruct], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[txn: IEndpoint.MintLpStruct], [void], "nonpayable">;
  getFunction(
