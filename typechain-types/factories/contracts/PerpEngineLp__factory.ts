...
import type {
  PerpEngineLp,
  PerpEngineLpInterface,
} from "../../contracts/PerpEngineLp";
...
export class PerpEngineLp__factory {
  static readonly abi = _abi;
  static createInterface(): PerpEngineLpInterface {
    return new Interface(_abi) as PerpEngineLpInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PerpEngineLp {
    return new Contract(address, _abi, runner) as unknown as PerpEngineLp;
  }
}
