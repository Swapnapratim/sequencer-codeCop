...
import type {
  SpotEngineLP,
  SpotEngineLPInterface,
} from "../../contracts/SpotEngineLP";
...
export class SpotEngineLP__factory {
  static readonly abi = _abi;
  static createInterface(): SpotEngineLPInterface {
    return new Interface(_abi) as SpotEngineLPInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SpotEngineLP {
    return new Contract(address, _abi, runner) as unknown as SpotEngineLP;
  }
}
