...
import type {
  ClearinghouseRisk,
  ClearinghouseRiskInterface,
} from "../../contracts/ClearinghouseRisk";
...
export class ClearinghouseRisk__factory {
  static readonly abi = _abi;
  static createInterface(): ClearinghouseRiskInterface {
    return new Interface(_abi) as ClearinghouseRiskInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ClearinghouseRisk {
    return new Contract(address, _abi, runner) as unknown as ClearinghouseRisk;
  }
}
