...
import type {
  PerpEngineState,
  PerpEngineStateInterface,
} from "../../contracts/PerpEngineState";
...
export class PerpEngineState__factory {
  static readonly abi = _abi;
  static createInterface(): PerpEngineStateInterface {
    return new Interface(_abi) as PerpEngineStateInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PerpEngineState {
    return new Contract(address, _abi, runner) as unknown as PerpEngineState;
  }
}
