...
import type {
  SpotEngineState,
  SpotEngineStateInterface,
} from "../../contracts/SpotEngineState";
...
export class SpotEngineState__factory {
  static readonly abi = _abi;
  static createInterface(): SpotEngineStateInterface {
    return new Interface(_abi) as SpotEngineStateInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SpotEngineState {
    return new Contract(address, _abi, runner) as unknown as SpotEngineState;
  }
}
